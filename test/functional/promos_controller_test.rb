...
class PromosControllerTest < ActionController::TestCase
  ...
  test "should create promo" do
    assert_difference('Promo.count') do
      post :create, promo: { description: @promo.description, id_marca: @promo.id_marca, id_tienda: @promo.id_tienda, name: @promo.name }
    end
  ...
  test "should update promo" do
    put :update, id: @promo, promo: { description: @promo.description, id_marca: @promo.id_marca, id_tienda: @promo.id_tienda, name: @promo.name }
    assert_redirected_to promo_path(assigns(:promo))
  end
